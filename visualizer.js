...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var audio1 = document.getElementById("myAudio"); // Get the audio element for visualizer1

  function initializeVisualizer() {
    visualizer1 = AUDIO.VISUALIZER.getInstance({
      autoplay: true,
      loop: true,
      audio: "myAudio",
      canvas: "myCanvas",
    ...
    var visualizer2 = AUDIO.VISUALIZER.getInstance({
      autoplay: true,
      loop: true,
      audio: "myAudio1",
      canvas: "myCanvas1",
    ...
    var visualizer3 = AUDIO.VISUALIZER.getInstance({
      autoplay: true,
      loop: true,
      audio: "myAudio1",
      canvas: "myCanvas2",
  ...
  // Create the AudioContext objects when this function is called.
});
